...
namespace Smile\ElasticsuiteCatalogPlugin\Model\Rewrite;
 ...
 * @author   Aurelien FOUCRET <aurelien.foucret@smile.fr>
 */
class AttributeConfig extends \Smile\ElasticsuiteCatalog\Model\Autocomplete\Product\AttributeConfig
{
    /**
     * @var string[]
     */
    ...
    public function __construct(
        ...
        $additionalSelectedAttributes = ['drug_name','ndc','sku','ndc_upc_hri_formatted']
    ) {
